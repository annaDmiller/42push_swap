...
/*   Updated: 2024/08/03 12:52:17 by amelniko         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	merge_sort(int **arr, int l_ind, int r_ind);

static int	merge(int **arr, int l_ind, int r_ind);

static void	merge_in_temp(int **arr, int **temp_arr, int l_ind, int r_ind);
